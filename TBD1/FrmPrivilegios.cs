    ...
    public partial class FrmPrivilegios : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (txtDescripcion.Text != "")
            {
                ...
                cmd.CommandText = "execute SP_Create_Privilegios @descripcion ='" + txtDescripcion.Text + "',@u_creador ='" + lblUser.Text + "',@u_modificador ='" + lblUser.Text + "'";
                cmd.ExecuteNonQuery();
        ...
        private void btnBuscarMod_Click(object sender, EventArgs e)
        {
            if (txtParamMod.Text != "")
            {
                ...
                cmd.CommandText = "execute SP_READ_PRIVILEGIOS @id =" + txtParamMod.Text;
                cmd.ExecuteNonQuery();
                ...
                {
                    txtDescripcion2.Text = dt.Rows[0]["descripcion_privilegio"].ToString();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "execute SP_READ_PRIVILEGIOS @id =" + txtParamBuscar.Text;
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            OdbcDataAdapter da = new OdbcDataAdapter(cmd);
            da.Fill(dt);
            ...
            {
                dt.Columns["id_privilegio"].ColumnName = "Id Rol";
                dt.Columns["descripcion_privilegio"].ColumnName = "Descripcion";
        ...
        private void btnGuardarMod_Click(object sender, EventArgs e)
        {
            if (txtDescripcion2.Text != "")
            {
                ...
                OdbcCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "execute SP_Update_Privilegio @id_privilegio = " + txtParamMod.Text + ",@descripcion = '" + txtDescripcion2.Text + "',@u_modificador = '" + lblUser.Text + "'";
                cmd.ExecuteNonQuery();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            OdbcCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "execute SP_READ_PRIVILEGIOS @id =" + txtParamEliminar.Text;
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            OdbcDataAdapter da = new OdbcDataAdapter(cmd);
            da.Fill(dt);
            ...
            if (x == 1)
            {
                ...
                cmd.CommandText = "execute SP_Delete_Privilegios @id =" + txtParamEliminar.Text;
                cmd.ExecuteNonQuery();
